...
st.title(APP_TITLE)
st.caption("This behavioral experiment was conducted as part of a Master’s thesis and involves presenting participants with the prices of ten different trips departing from Marquês de Pombal.")
